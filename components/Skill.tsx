  ...
  return (
    <div className="group relative flex cursor-pointer ">
      <motion.img
        ...
        src={img}
        className=" rounded-full border border-gray-500 object-cover p-2 w-24 h-24 xl:w-26 xl:h-26 group-hover:grayscale transition-all duration-300 ease-in-out	"
      ></motion.img>
