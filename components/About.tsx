...
function About() {
  return (
    <motion.div
      ...
      className="min-h-screen h-auto py-20 text-[#dbdbdb] flex relative flex-col text-center max-w-4xl px-4 md:px-10 justify-center mx-auto items-center gap-8"
    >
      ...
      <motion.div
        ...
        className="w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full flex-shrink-0 relative overflow-hidden mt-16 md:mt-20"
      >
        <Image
      ...
      <div className="space-y-4 md:space-y-6 px-4 md:px-8 max-w-3xl text-center">
        <h4 className="text-lg sm:text-xl md:text-2xl lg:text-4xl font-semibold">
          Here is a{" "}
          <span className="underline decoration-[#f7ab0a]/50">little</span>{" "}
          background about me
        </h4>
        <div className="text-sm sm:text-base md:text-lg leading-relaxed max-w-prose mx-auto text-center">
