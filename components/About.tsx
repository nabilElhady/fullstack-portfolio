...
function About() {
  return (
    <motion.div
      ...
      className="min-h-screen h-auto py-20 md:py-0 md:h-screen text-[#dbdbdb] flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-4 md:px-10 justify-center md:justify-evenly mx-auto items-center gap-8 md:gap-0"
    >
      ...
      <motion.div
        ...
        className="w-32 h-32 sm:w-40 sm:h-40 md:w-64 md:h-64 xl:w-[300px] xl:h-[300px] rounded-full flex-shrink-0 relative overflow-hidden mt-16 md:mt-0"
      >
        <Image
          ...
          sizes="(max-width: 640px) 128px, (max-width: 768px) 160px, (max-width: 1280px) 256px, 300px"
        />
      </motion.div>
      <div className="space-y-4 md:space-y-6 px-4 md:px-10 max-w-full md:max-w-2xl">
        <h4 className="text-lg sm:text-xl md:text-2xl lg:text-4xl font-semibold">
          Here is a{" "}
          <span className="underline decoration-[#f7ab0a]/50">little</span>{" "}
          background about me
        </h4>
        <div className="text-sm sm:text-base md:text-lg leading-relaxed max-w-prose mx-auto md:mx-0">
